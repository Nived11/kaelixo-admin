      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-[11px] text-gray-700 font-medium">Create and configure a company account across KAELIXO products and billing accounts.</p>
          </div>
        </div>
      </div>
            ...
            {topStats.map((item, i) => (
              <div key={i} className="bg-white rounded-xl p-4 border border-gray-100 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.04)] relative overflow-hidden flex items-center gap-3 h-[130px] shadow-sm hover:shadow-md transition-all">
                ...
                <div className="flex flex-col flex-1 relative z-10 min-w-0 justify-center">
                  ...
                  {/* Subtitle at Bottom */}
                  <p className="text-[10px] text-gray-700 font-medium mt-1 truncate">{item.sub}</p>
                </div>
              ...
              <div>
                <div className="flex items-start gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-[10.5px] text-gray-700 font-medium mt-0.5">Basic details about the company.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <input type="text" placeholder="e.g. ABC Travels" className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="e.g. ABC Travels Private Limited" className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <div className="relative">
                      <select className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 appearance-none text-gray-700 focus:outline-none focus:border-[#7a42ff]">
                        <option>Select company type</option>
                      </select>
                      <ChevronDown size={13} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-700 pointer-events-none" />
                    </div>
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <LinkIcon size={12} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-700" />
                      <input type="text" placeholder="https://www.example.com" className="w-full text-xs border border-gray-300 rounded-lg pl-8 pr-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                    </div>
                  </div>
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      <textarea 
                        ...
                        className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 pb-7 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600 resize-none min-h-[70px]" 
                      />
                      <span className="absolute bottom-2.5 right-3 text-[9px] text-gray-700 font-medium bg-white px-1">0/500</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-start gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-[10.5px] text-gray-700 font-medium mt-0.5">Primary contact and admin account information.</p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <input type="text" placeholder="e.g. Rajesh Kumar" className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="email" placeholder="rajesh@company.com" className="w-full text-xs border border-gray-300 rounded-lg pl-8 pr-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-[10.5px] font-bold text-[#030C25] mb-1.5">Phone Number</label>
                    <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden h-[38px] focus-within:border-[#7a42ff]">
                      <div className="flex items-center px-2 bg-gray-50 border-r border-gray-300 h-full">
                        <Phone size={12} className="text-gray-700 mr-1" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input type="text" placeholder="e.g. Priya Sharma" className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                  </div>
                  <div>
                    <label className="block text-[10.5px] font-bold text-[#030C25] mb-1.5">Admin Email <span className="text-rose-500">*</span></label>
                    <div className="relative">
                      <Mail size={12} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-700" />
                      <input type="email" placeholder="admin@company.com" className="w-full text-xs border border-gray-300 rounded-lg pl-8 pr-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                    </div>
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-xl py-2">
                <div className="flex items-start gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-[10.5px] text-gray-700 font-medium mt-0.5">Select products and subscription details.</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col xl:flex-row gap-3.5 mb-4" ref={productDropdownRef}>
                  ...
                  <div className="flex-[1.5] xl:flex-[2] relative">
                    ...
                    <div 
                      ...
                      className="flex flex-wrap gap-1.5 p-1 border border-gray-300 rounded-lg items-center cursor-text relative min-h-[38px] focus-within:border-[#7a42ff] pr-8"
                    >
                    ...
                    {isProductDropdownOpen && (
                      <div className="absolute left-0 right-0 top-full mt-1 bg-white border border-gray-300 rounded-xl shadow-lg z-50 max-h-40 overflow-y-auto">
                        <div className="p-1.5 text-[10px] text-gray-700 font-semibold px-2.5 border-b border-gray-200">Available Products</div>
                        {availableProducts
                  ...
                  <div className="flex-1">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 appearance-none text-gray-700 focus:outline-none focus:border-[#7a42ff]"
                      >
                  ...
                  <div className="w-[110px] shrink-0">
                    ...
                    <div className="flex items-center bg-gray-50 rounded-lg p-0.5 border border-gray-100 h-[38px]">
                      <button 
                        ...
                        className={`flex-1 text-[10px] font-bold rounded-md py-1.5 transition-colors ${formData.accountType === 'Trial' ? 'bg-[#5c45fd] text-white shadow-sm' : 'text-gray-700 hover:text-gray-700'}`}
                      >
                        Trial
                      </button>
                      <button 
                        onClick={() => handleChange("accountType", "Live")}
                        className={`flex-1 text-[10px] font-bold rounded-md py-1.5 transition-colors ${formData.accountType === 'Live' ? 'bg-[#5c45fd] text-white shadow-sm' : 'text-gray-700 hover:text-gray-700'}`}
                      >
                        Live
                      </button>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" value={formData.startDate} onChange={(e) => handleChange("startDate", e.target.value)} className="w-full text-xs border border-gray-300 rounded-lg pl-8 pr-3 py-2.5 text-gray-600 focus:outline-none focus:border-[#7a42ff]" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      <Calendar size={12} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-700" />
                      <input type="text" value={formData.renewalDate} onChange={(e) => handleChange("renewalDate", e.target.value)} className="w-full text-xs border border-gray-300 rounded-lg pl-8 pr-3 py-2.5 text-gray-600 focus:outline-none focus:border-[#7a42ff]" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-start gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-[10.5px] text-gray-700 font-medium mt-0.5">Billing configuration and financial details.</p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <select className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 appearance-none text-[#030C25] font-semibold focus:outline-none focus:border-[#7a42ff]">
                        <option>INR (₹)</option>
                      </select>
                      <ChevronDown size={13} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-700 pointer-events-none" />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Mail size={12} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-700" />
                      <input type="email" placeholder="billing@company.com" className="w-full text-xs border border-gray-300 rounded-lg pl-8 pr-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-[10.5px] font-bold text-[#030C25] mb-1.5">Invoice Notes</label>
                    <input type="text" placeholder="Additional notes for invoices..." className="w-full text-xs border border-gray-300 rounded-lg px-3 py-2.5 focus:outline-none focus:border-[#7a42ff] placeholder:text-gray-600" />
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-start gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-[10.5px] text-gray-700 font-medium mt-0.5">Region settings and account provisioning.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 items-end">
                  ...
                  <div className="xl:col-span-1">
                    ...
                    <div className="relative">
                      ...
                      <select 
                        ...
                        className="w-full text-xs border border-gray-300 rounded-lg pl-8 pr-3 py-2.5 appearance-none text-gray-700 focus:outline-none focus:border-[#7a42ff] bg-white h-[38px]"
                      >
                  ...
                  <div className="xl:col-span-1">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className="w-full text-xs border border-gray-300 rounded-lg pl-3 pr-7 py-2.5 appearance-none text-gray-700 focus:outline-none focus:border-[#7a42ff] bg-white h-[38px]"
                      >
                        <option value="">Select time zone</option>
                        <option value="IST">(GMT+05:30) India Standard Time (IST)</option>
                  ...
                  {/* Workspace / Subdomain + Toggles + Status */}
                  <div className="xl:col-span-2 flex flex-col md:flex-row gap-4 items-start md:items-center w-full">
                    ...
                    <div className="w-full md:flex-1">
                      ...
                      <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden h-[38px] focus-within:border-[#7a42ff] bg-white w-full">
                        <div className="relative flex-1 flex items-center h-full min-w-0">
                          <LinkIcon size={12} className="absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-700" />
                          <input 
                            type="text" 
                        ...
                        <span className="text-[10px] font-medium text-gray-700 bg-gray-50 border-l border-gray-300 px-2.5 py-2.5 whitespace-nowrap h-full flex items-center shrink-0">
                          .kaelixo.com
                        </span>
                      </div>
                    </div>
                    ...
                    {/* Toggles */}
                    <div className="flex flex-row md:flex-col gap-4 md:gap-2.5 shrink-0 pt-1 md:pt-4 w-full md:w-auto overflow-x-auto">
                      <div className="flex items-center gap-2 cursor-pointer shrink-0" onClick={() => handleChange("autoProvision", !formData.autoProvision)}>
                        <div className={`w-6 h-3.5 rounded-full flex items-center px-0.5 transition-colors ${formData.autoProvision ? 'bg-[#5c45fd]' : 'bg-gray-300'}`}>
                          <div className={`w-2.5 h-2.5 bg-white rounded-full transition-transform ${formData.autoProvision ? 'translate-x-2.5' : 'translate-x-0'}`}></div>
                        </div>
                        <span className="text-[9.5px] font-medium text-gray-700 select-none whitespace-nowrap">Auto-provision company</span>
                      </div>
                      <div className="flex items-center gap-2 cursor-pointer shrink-0" onClick={() => handleChange("sendOnboarding", !formData.sendOnboarding)}>
                        <div className={`w-6 h-3.5 rounded-full flex items-center px-0.5 transition-colors ${formData.sendOnboarding ? 'bg-[#5c45fd]' : 'bg-gray-300'}`}>
                          <div className={`w-2.5 h-2.5 bg-white rounded-full transition-transform ${formData.sendOnboarding ? 'translate-x-2.5' : 'translate-x-0'}`}></div>
                        </div>
                        <span className="text-[9.5px] font-medium text-gray-700 select-none whitespace-nowrap">Send onboarding email</span>
                      </div>
                    </div>

                    {/* Account Status */}
                    <div className="w-full md:w-auto shrink-0 pt-1 md:pt-2">
                      <label className="block text-[9px] text-gray-700 mb-1.5 md:mb-1">Account Status *</label>
                      <div className="relative">
                        <select 
                          value={formData.status}
                          onChange={(e) => handleChange("status", e.target.value)}
                          className="w-full md:w-[100px] text-[10px] font-bold text-emerald-600 border border-gray-300 rounded-lg px-2.5 py-2 appearance-none focus:outline-none focus:border-[#7a42ff] bg-white h-[38px]"
                        >
                          <option value="Active">Active</option>
                          <option value="Pending">Pending</option>
                          <option value="Inactive">Inactive</option>
                        </select>
                        <ChevronDown size={10} className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-700 pointer-events-none" />
                      </div>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.04)]">
            ...
            <div className="flex items-center gap-3 pb-4 border-b border-gray-100">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[9.5px] text-gray-700 truncate mt-0.5">Travel and Tourism Solutions</p>
            ...
            <div className="py-3 space-y-2.5 text-[10.5px]">
              <div className="flex justify-between items-center">
                <span className="text-gray-700 flex items-center gap-1.5"><Calendar size={11} /> Plan</span>
                <span className="font-bold text-[#5c45fd] bg-purple-50 px-2 py-0.5 rounded-full">Enterprise</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700 flex items-center gap-1.5"><Globe size={11} /> Region</span>
                <span className="font-bold text-[#030C25] flex items-center gap-1">🇮🇳 India</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700 flex items-center gap-1.5"><IndianRupee size={11} /> Estimated MRR</span>
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.04)]">
            ...
            <div className="space-y-2.5 text-[10.5px]">
              {checklist.map((item, i) => (
                <div key={i} className="flex items-center justify-between text-gray-700 font-medium">
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-100 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.04)]">
            ...
            <div className="space-y-2 text-[10.5px] border-b border-gray-100 pb-3">
              <div className="flex justify-between">
                <span className="text-gray-700">Plan (Enterprise)</span>
            ...
            <div className="flex justify-between items-center pt-3 text-[11px]">
              <span className="font-bold text-[#030C25]">Estimated Total <span className="text-gray-700 font-normal">(Monthly)</span></span>
              ...
              <div className="flex items-center justify-between cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-gray-700">Send an invitation to company admin</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-gray-700">Send onboarding instructions</p>
                  </div>
                </div>
                <ChevronRight size={13} className="text-gray-600" />
              </div>
              <div className="flex items-center justify-between cursor-pointer group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-gray-700">Generate initial invoice</p>
                  </div>
                </div>
                <ChevronRight size={13} className="text-gray-600" />
              </div>
