    ...
    <div className="space-y-6 max-w-[1600px] mx-auto pb-6">
      ...
      {currentView === "overview" ? (
        <>
          ...
          {/* 3. Products Overview Component with navigate callback */}
          <ProductsOverview onNavigate={(view) => setCurrentView(view as "overview" | "create")} />
          ...
          {/* 6. Bottom Action Banner with navigate callback */}
          <DashboardBottomBanner onNavigate={(view) => setCurrentView(view as "overview" | "create")} />
        </>
      ) : (
        /* Render Add New Product Form with Dashboard origin breadcrumb */
        <ProductForm origin="Dashboard" onBack={() => setCurrentView("overview")} />
      )}
